 ...
 * @author JLI 
 * @version 001
 * Esta clase saca el tamaÃ±o de una cadena de caracteres, la recorre y la imprime de manera vertical
 */
public class recorrerCadenaCaracteres
{
    public static void main (String[] args)
    {
        ...
        String cadena2 = "se usarÃ¡n algunos mÃ©todos de la clase String";
        String cadena3 = "";
        ...
        /**
         * Para encontrar el tamaÃ±o de la cadena utilizo el mÃ©todo length() de la clase String
         * length() devuelve un nÃºmero entero
         */
        System.out.print ("El contenido de la variable cadena1 es: "+ cadena1 + "\n");
        System.out.print ("El tamaÃ±o total de la variable cadena1 es: "+ cadena1.length()+ " caracteres\n");

        System.out.print ("\nEl contenido de la variable cadena2 es: "+ cadena2 + "\n");
        System.out.print ("El tamaÃ±o total de la variable cadena2 es: "+ cadena2.length()+ " caracteres\n");

        System.out.print ("El contenido de la variable cadena3 es: "+ cadena3 + "\n");
        System.out.print ("El tamaÃ±o total de la variable cadena3 es: "+ cadena3.length()+ " caracteres\n");
